  ...
  switch (args[0].toLowerCase()) {
    case "help":
      ...
      let em = new Discord.RichEmbed()
        ...
        .addField(`!play [link|search|playlist]`, `Plays a song in the current channel.`)
        .addField(`!skip`, `Skips the current song.`)
        .addField(`!stop`, `Stops and drops everything.`)
        .addField(`!queue`, `Shows the first 5 songs in the queue.`)
        .addField(`!np`, `Shows what is now playing.`);
